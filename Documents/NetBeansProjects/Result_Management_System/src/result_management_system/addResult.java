...
public class addResult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Math's");

        jButton6.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/result_management_system/data-storage.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //this is button of adding student..
        setVisible(false);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        //this is the main area where I've to collect the data deal with the data base..
        ...
        //before this create a result table int databse... name as studentrms..
          ...
          try
       {
          ...
          Class.forName("com.mysql.jdbc.Driver");
           ...
           //It may return the set of values..
           //It will have next function will actually gives you the result..
           if(rs.next())
           {
               st.executeUpdate("Insert into result (rollno,physics,maths,em,dbms,os) values('"+roll+"','"+physics+"','"+maths+"','"+em+"','"+dbms+"','"+os+"')");
                 JOptionPane.showMessageDialog(null, "Rsult Saved Successfully");
           setVisible(false);
           new addResult().setVisible(true);
           }
           else
